// quiz.js — labels cleaned (no "(5 …" / "(1 …)"), same scoring, random tie-break,
// links to the newest matching comic page by title.
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (!bodyEl || !progressEl || !nextBtn || !prevBtn) {
    console.error('[quiz] Missing required elements on the page.');
    return;
  }
